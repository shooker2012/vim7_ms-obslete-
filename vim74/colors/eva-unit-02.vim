" Vim color scheme
" Name:         eva-unit-02.vim
" Author:       shooker2012 <lovelywzz@gmail.com>
" Version:      1.0
...
if &background == "light" || has("gui_running")
    hi Normal guibg=#1B1D1E ctermbg=Black
else
    hi Normal guibg=#1B1D1E ctermbg=NONE
endif
...
call s:hifg("String"         ,"#55cc00","LightGreen",44,82) " 82
